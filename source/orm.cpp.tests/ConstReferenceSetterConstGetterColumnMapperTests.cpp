...
{
	ConstReferenceSetterConstGetterColumnMapper<TestMappingEntity, int32_t> mapper(&TestMappingEntity::ConstReferenceSetterConstGetterSetter, &TestMappingEntity::ConstReferenceSetterConstGetterGetter, "ConstReferenceSetterConstGetter");
...
TEST(ConstReferenceSetterConstGetterColumnMapperTests, IsForMember_ConstGetterMember_ReturnsTrue)
{
	...
	EXPECT_TRUE(iMapper.IsForMember<int32_t>(&TestMappingEntity::ConstReferenceSetterConstGetterGetter));
}
