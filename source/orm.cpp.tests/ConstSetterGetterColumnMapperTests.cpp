...
{
	ConstSetterGetterColumnMapper<TestMappingEntity, std::int32_t> mapper(&TestMappingEntity::ConstSetterGetterSetter, &TestMappingEntity::ConstSetterGetterGetter, "ConstSetterGetter");
...
TEST(ConstSetterGetterColumnMapperTests, IsForMember_GetterMember_ReturnsTrue)
{
	...
	EXPECT_TRUE(iMapper.IsForMember<std::int32_t>(&TestMappingEntity::ConstSetterGetterGetter));
}
