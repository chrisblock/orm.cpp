...
{
	ConstReferenceSetterConstReferenceGetterColumnMapper<TestMappingEntity, int32_t> mapper(&TestMappingEntity::ConstReferenceSetterConstReferenceGetterSetter, &TestMappingEntity::ConstReferenceSetterConstReferenceGetterGetter, "ConstReferenceSetterConstReferenceGetter");
...
TEST(ConstReferenceSetterConstReferenceGetterColumnMapperTests, IsForMember_ConstReferenceGetterMember_ReturnsTrue)
{
	...
	EXPECT_TRUE(iMapper.IsForMember<int32_t>(&TestMappingEntity::ConstReferenceSetterConstReferenceGetterGetter));
}
