...
{
	ReferenceSetterReferenceGetterColumnMapper<TestMappingEntity, std::int32_t> mapper(&TestMappingEntity::ReferenceSetterReferenceGetterSetter, &TestMappingEntity::ReferenceSetterReferenceGetterGetter, "ReferenceSetterReferenceGetter");
...
TEST(ReferenceSetterReferenceGetterColumnMapperTests, IsForMember_ReferenceGetterMember_ReturnsTrue)
{
	...
	EXPECT_TRUE(iMapper.IsForMember<std::int32_t>(&TestMappingEntity::ReferenceSetterReferenceGetterGetter));
}
