...
{
	ConstSetterConstGetterColumnMapper<TestMappingEntity, std::int32_t> mapper(&TestMappingEntity::ConstSetterConstGetterSetter, &TestMappingEntity::ConstSetterConstGetterGetter, "ConstSetterConstGetter");
...
TEST(ConstSetterConstGetterColumnMapperTests, IsForMember_ConstGetterMember_ReturnsTrue)
{
	...
	EXPECT_TRUE(iMapper.IsForMember<std::int32_t>(&TestMappingEntity::ConstSetterConstGetterGetter));
}
