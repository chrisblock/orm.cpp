...
class ConstReferenceSetterConstGetterColumnMapper : public IColumnMapper<TEntity>
{
public:
	...
	ConstReferenceSetterConstGetterColumnMapper(const_reference_setter setter, const_getter getter, const std::string &columnName) :
		  _getter(getter)
		, _setter(setter)
	...
	ConstReferenceSetterConstGetterColumnMapper(const ConstReferenceSetterConstGetterColumnMapper<TEntity, TProperty> &other) :
	...
	virtual ~ConstReferenceSetterConstGetterColumnMapper()
	{
	};
