...
class ReferenceSetterConstGetterColumnMapper : public IColumnMapper<TEntity>
{
public:
	...
	ReferenceSetterConstGetterColumnMapper(reference_setter setter, const_getter getter, const char *columnName) :
		  _getter(getter)
		, _setter(setter)
	...
	ReferenceSetterConstGetterColumnMapper(const ReferenceSetterConstGetterColumnMapper<TEntity, TProperty> &other) :
	...
	virtual ~ReferenceSetterConstGetterColumnMapper()
	{
	};
