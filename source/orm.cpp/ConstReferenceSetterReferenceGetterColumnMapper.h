...
class ConstReferenceSetterReferenceGetterColumnMapper : public IColumnMapper<TEntity>
{
public:
	...
	ConstReferenceSetterReferenceGetterColumnMapper(const_reference_setter setter, reference_getter getter, const std::string &columnName) :
		  _getter(getter)
		, _setter(setter)
	...
	ConstReferenceSetterReferenceGetterColumnMapper(const ConstReferenceSetterReferenceGetterColumnMapper<TEntity, TProperty> &other) :
	...
	virtual ~ConstReferenceSetterReferenceGetterColumnMapper()
	{
	};
