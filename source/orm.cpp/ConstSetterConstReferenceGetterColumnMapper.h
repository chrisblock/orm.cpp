...
class ConstSetterConstReferenceGetterColumnMapper : public IColumnMapper<TEntity>
{
public:
	...
	ConstSetterConstReferenceGetterColumnMapper(const_setter setter, const_reference_getter getter, const std::string &columnName) :
		  _getter(getter)
		, _setter(setter)
	...
	ConstSetterConstReferenceGetterColumnMapper(const ConstSetterConstReferenceGetterColumnMapper<TEntity, TProperty> &other) :
	...
	virtual ~ConstSetterConstReferenceGetterColumnMapper()
	{
	};
